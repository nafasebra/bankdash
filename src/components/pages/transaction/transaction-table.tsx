              ...
              <tr>
                <td className="px-5 py-5 bg-white">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-primary-200">Molly Sanders</p>
                  </div>
                </td>
                ...
                <td className="px-5 py-5 bg-white text-sm text-right">
                  <a
                    href="#"
                    className="mx-auto flex items-center justify-center py-2 px-4 rounded-full border-2 border-primary-400 text-primary-400 text-center"
                  >
                    Download
                  </a>
                </td>
