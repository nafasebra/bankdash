    ...
    <div className="overflow-hidden">
      <ul className="min-w-full overflow-x-auto space-y-3">
        {Array.from({ length: 4 }).map((_, index) => (
          <li
            key={index}
            className="min-w-[700px] bg-white rounded-lg flex gap-8 justify-between items-center py-4 px-5"
          >
            <div className="flex items-center gap-5">
              <div
                className={`w-14 h-14 flex items-center justify-center rounded-full bg-magenta/20 text-magenta`}
              >
              ...
              <div className="text-lg flex flex-col whitespace-nowrap">
                ...
                <p className="text-primary-400 leading-none">
