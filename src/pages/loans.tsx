  ...
  return (
    <Body pageName={linkEnum.Loans}>
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5'>
        <IconCard icon={<AccountIcon />} supTitle='Personal Loans' title='$50,000' mainColor='text-primary-100' mainColorAlpha='bg-primary-100/20' />
        <IconCard icon={<Service2nIcon />} supTitle='Corporate Loans' title='$100,000' mainColor='text-yellow' mainColorAlpha='bg-yellow/20' />
